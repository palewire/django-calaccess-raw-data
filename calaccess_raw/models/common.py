...
in the STATUS_TYPE and STATUS_DESC columns on FILER_STATUS_TYPES_CD",
        documentcloud_pages=[DocumentCloud(id="2774537", start_page=1)],
    )
...
politicans and officers tend to use both the first and last name.",
    ...
    namf = fields.CharField(
        max_length=55, db_column="NAMF", blank=True, help_text="First name"
    )
    namt = fields.CharField(
        max_length=70, db_column="NAMT", blank=True, help_text="Name prefix or title"
    )
    nams = fields.CharField(
        max_length=32, db_column="NAMS", blank=True, help_text="Name suffix"
    )
    ...
    city = fields.CharField(
        max_length=55, db_column="CITY", blank=True, help_text="City address"
    )
    st = fields.CharField(
        max_length=4,
        db_column="ST",
    ...
    zip4 = fields.CharField(
        max_length=10, db_column="ZIP4", blank=True, help_text="ZIP Code"
    )
    ...
    fax = fields.CharField(
        max_length=60, db_column="FAX", blank=True, help_text="Fax number"
    )
    email = fields.CharField(
        max_length=60, db_column="EMAIL", blank=True, help_text="Email address"
    )
...
class FilerFilingsCd(CalAccessBaseModel):
    ...
    UNIQUE_KEY = ("FILER_ID", "FILING_ID", "FORM_ID", "FILING_SEQUENCE")
    DOCUMENTCLOUD_PAGES = [
...
original filing and 1 to 999 amendments.",
    ...
    EF_TYPE_CHOICES = (("CAL", ".CAL format"),)
    ...
    STATE_CD_CHOICES = (("CA", "California"),)
...
class HeaderCd(CalAccessBaseModel):
    ...
    line_number = fields.IntegerField(
        db_column="LINE_NUMBER", help_text="This field is undocumented"
    )
    FORM_ID_CHOICES = (
    ...
    label = fields.CharField(
        db_column="LABEL", max_length=98, help_text="This field is undocumented"
    )
...
original filing and 1 to 999 amendments.",
    ...
    ENTITY_CODE_CHOICES = annotations.sort_choices(
    ...
    filer_naml = fields.CharField(
        db_column="FILER_NAML", max_length=200, help_text="Filer last name"
    )
    filer_namf = fields.CharField(
        db_column="FILER_NAMF", max_length=4, blank=True, help_text="Filer first name"
    )
    ...
    filer_nams = fields.CharField(
        db_column="FILER_NAMS", max_length=32, blank=True, help_text="Filer suffix"
    )
    ...
    rpt_date = fields.DateField(
        db_column="RPT_DATE", null=True, help_text="This field is undocumented"
    )
    filer_city = fields.CharField(
        db_column="FILER_CITY", max_length=16, blank=True, help_text="Filer city"
    )
    filer_st = fields.CharField(
        db_column="FILER_ST", max_length=4, blank=True, help_text="Filer state"
    )
    filer_zip4 = fields.CharField(
        db_column="FILER_ZIP4", max_length=10, blank=True, help_text="Filer ZIP Code"
    )
    ...
    cand_naml = fields.CharField(
        db_column="CAND_NAML", max_length=46, help_text="Candidate last name"
    )
    ...
    cand_nams = fields.CharField(
        db_column="CAND_NAMS", max_length=32, blank=True, help_text="Candidate suffix"
    )
    DISTRICT_CD_CHOICES = (
        (0, "N/A"),
        (17001, "01"),
    ...
    pmnt_dt = fields.DateField(
        db_column="PMNT_DT", null=True, help_text="This field is undocumented"
    )
    pmnt_amount = fields.FloatField(
        db_column="PMNT_AMOUNT", help_text="This field is undocumented"
    )
    type_literature = fields.IntegerField(
        db_column="TYPE_LITERATURE", help_text="This field is undocumented"
    )
    type_printads = fields.IntegerField(
        db_column="TYPE_PRINTADS", help_text="This field is undocumented"
    )
    type_radio = fields.IntegerField(
        db_column="TYPE_RADIO", help_text="This field is undocumented"
    )
    type_tv = fields.IntegerField(
        db_column="TYPE_TV", help_text="This field is undocumented"
    )
    type_it = fields.IntegerField(
        db_column="TYPE_IT", help_text="This field is undocumented"
    )
    type_billboards = fields.IntegerField(
        db_column="TYPE_BILLBOARDS", help_text="This field is undocumented"
    )
...
class AcronymsCd(CalAccessBaseModel):
    ...
    acronym = fields.CharField(
        max_length=40, db_column="ACRONYM", help_text="Acronym text value"
    )
    stands_for = fields.CharField(
        max_length=4, db_column="STANDS_FOR", help_text="Definition of the acronym"
    )
    effect_dt = fields.DateField(
        null=True, db_column="EFFECT_DT", help_text="Effective date for the acronym"
    )
    a_desc = fields.CharField(
        max_length=50, db_column="A_DESC", help_text="Description of the acronym"
    )
...
class AddressCd(CalAccessBaseModel):
    ...
    city = fields.CharField(max_length=500, db_column="CITY", help_text="Address city")
    st = fields.CharField(
        max_length=500, db_column="ST", verbose_name="State", help_text="Address state"
    )
    zip4 = fields.CharField(
        db_column="ZIP4", null=True, max_length=10, help_text="Address ZIP Code"
    )
    phon = fields.CharField(
        db_column="PHON",
        null=True,
    ...
    fax = fields.CharField(
        db_column="FAX", null=True, max_length=20, help_text="Address fax number"
    )
    email = fields.CharField(
        max_length=500, db_column="EMAIL", help_text="Address email"
    )
...
class FilerAcronymsCd(CalAccessBaseModel):
    ...
    acronym = fields.CharField(
        db_column="ACRONYM", max_length=32, help_text="AMS acronym"
    )
    filer_id = fields.IntegerField(
        verbose_name="filer ID",
        db_column="FILER_ID",
...
class FilerTypesCd(CalAccessBaseModel):
    ...
    calc_use = fields.CharField(
        max_length=1, db_column="CALC_USE", blank=True, help_text="Use checkbox flag"
    )
...
class FilingPeriodCd(CalAccessBaseModel):
    ...
    period_id = fields.IntegerField(
        db_column="PERIOD_ID", help_text="Unique period identification number"
    )
    start_date = fields.DateField(
        db_column="START_DATE", null=True, help_text="Starting date for period"
    )
    end_date = fields.DateField(
        db_column="END_DATE", null=True, help_text="Ending date of period"
    )
    PERIOD_TYPE_CHOICES = ((1500, "Standard period"),)
    ...
    PER_GRP_TYPE_CHOICES = ((1500, "STANDARD PERIOD"),)
    ...
    period_desc = fields.CharField(
        max_length=255, db_column="PERIOD_DESC", help_text="Period description"
    )
    deadline = fields.DateField(
        db_column="DEADLINE", null=True, help_text="Deadline date"
    )
...
class LegislativeSessionsCd(CalAccessBaseModel):
    ...
    begin_date = fields.DateField(
        db_column="BEGIN_DATE", null=True, help_text="Session start date"
    )
    end_date = fields.DateField(
        db_column="END_DATE", null=True, help_text="Session end date"
    )
...
class ReceivedFilingsCd(CalAccessBaseModel):
    ...
    receive_comment = fields.CharField(
        db_column="RECEIVE_COMMENT", max_length=120, help_text="A comment"
    )
...
class ReportsCd(CalAccessBaseModel):
    ...
    rpt_id = fields.IntegerField(
        db_column="RPT_ID", help_text="Unique identification number"
    )
    rpt_name = fields.CharField(
        db_column="RPT_NAME", max_length=74, help_text="Name of the report"
    )
    ...
    path = fields.CharField(
        db_column="PATH", max_length=32, blank=True, help_text="Report path"
    )
    data_object = fields.CharField(
        db_column="DATA_OBJECT", max_length=38, help_text="This field is undocumented"
    )
    ...
    parm_definition = fields.IntegerField(
        db_column="PARM_DEFINITION", help_text="Parameter definition"
    )
