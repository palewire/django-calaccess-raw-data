...
SMO - Slate Mailer Organization (F400,402) [COM|RCP] - Recipient Committee (F410)",
    ...
    REC_TYPE_CHOICES = (
        (
            "CVR",
            "Cover Page for Stmt of Organization / Slate Mailer Org, Stmt of \
...
original filing and 1 to 999 amendments.",
    ...
    REC_TYPE_CHOICES = (("CVR2", "Cover Page; Additional Names & Addresses"),)
    rec_type = fields.CharField(
        choices=REC_TYPE_CHOICES,
        db_column="REC_TYPE",
        max_length=4,
...
values are 'X' or null. Applies to the Form 461.",
    ...
    filer_city = fields.CharField(
        max_length=30, db_column="FILER_CITY", blank=True, help_text="Filer's city"
    )
    filer_fax = fields.CharField(
        max_length=20, db_column="FILER_FAX", blank=True, help_text="Filer's fax"
    )
    filer_id = fields.CharField(
        verbose_name="filer ID",
        db_column="FILER_ID",
...
individual the filer's last name.",
    ...
    filer_st = fields.CharField(
        max_length=4, db_column="FILER_ST", blank=True, help_text="Filer state"
    )
    filer_zip4 = fields.CharField(
        max_length=10, db_column="FILER_ZIP4", blank=True, help_text="Filer ZIP Code"
    )
    filing_id = fields.IntegerField(
        db_column="FILING_ID",
        db_index=True,
...
values are 'Y' or 'N'.",
    ...
    REC_TYPE_CHOICES = (("CVR", "Cover Page"),)
    rec_type = fields.CharField(
        verbose_name="record type",
        db_column="REC_TYPE",
        max_length=4,
...
with in the record.",
    ...
    enty_city = fields.CharField(
        max_length=30, db_column="ENTY_CITY", blank=True, help_text="Entity city"
    )
    ...
    enty_fax = fields.CharField(
        max_length=20, db_column="ENTY_FAX", blank=True, help_text="Entity fax number"
    )
    enty_namf = fields.CharField(
        max_length=45,
        db_column="ENTY_NAMF",
    ...
    enty_st = fields.CharField(
        max_length=2, db_column="ENTY_ST", blank=True, help_text="Entity state"
    )
    enty_zip4 = fields.CharField(
        max_length=10, db_column="ENTY_ZIP4", blank=True, help_text="Entity ZIP code"
    )
    F460_PART_CHOICES = (
    ...
    mail_st = fields.CharField(
        max_length=2, db_column="MAIL_ST", blank=True, help_text="Filer's mailing state"
    )
    mail_zip4 = fields.CharField(
        max_length=10,
        db_column="MAIL_ZIP4",
    ...
    REC_TYPE_CHOICES = (("CVR2", "Cover, Page 2"),)
    rec_type = fields.CharField(
        verbose_name="record type",
        db_column="REC_TYPE",
        max_length=4,
...
original filing and 1 to 999 amendments.",
    ...
    REC_TYPE_CHOICES = (("CVR3", "Cover Page 3, Verification Information"),)
    rec_type = fields.CharField(
        verbose_name="record type",
        db_column="REC_TYPE",
        max_length=4,
...
original filing and 1 to 999 amendments.",
    ...
    cand_nams = fields.CharField(
        max_length=10, db_column="CAND_NAMS", blank=True, help_text="Candidate's Suffix"
    )
    cand_namt = fields.CharField(
        max_length=10,
        db_column="CAND_NAMT",
    ...
    # )
    payee_city = fields.CharField(
        max_length=30, db_column="PAYEE_CITY", blank=True, help_text="Payee City"
    )
    payee_namf = fields.CharField(
        max_length=45,
        db_column="PAYEE_NAMF",
    ...
    payee_nams = fields.CharField(
        max_length=10, db_column="PAYEE_NAMS", blank=True, help_text="Payee's Suffix"
    )
    payee_namt = fields.CharField(
        max_length=10,
        db_column="PAYEE_NAMT",
    ...
    payee_st = fields.CharField(
        max_length=2, db_column="PAYEE_ST", blank=True, help_text="State code"
    )
    payee_zip4 = fields.CharField(
        max_length=10, db_column="PAYEE_ZIP4", blank=True, help_text="Zip+4"
    )
    REC_TYPE_CHOICES = (("EXPN", "Expense"),)
    rec_type = fields.CharField(
        verbose_name="record type",
        db_column="REC_TYPE",
        max_length=4,
    ...
    # )
    tres_city = fields.CharField(
        max_length=30, db_column="TRES_CITY", blank=True, help_text="Treasurer City"
    )
    tres_namf = fields.CharField(
        max_length=45,
        db_column="TRES_NAMF",
    ...
    tres_nams = fields.CharField(
        max_length=10, db_column="TRES_NAMS", blank=True, help_text="Treasurer's Suffix"
    )
    tres_namt = fields.CharField(
        max_length=10,
        db_column="TRES_NAMT",
    ...
    tres_st = fields.CharField(
        max_length=2, db_column="TRES_ST", blank=True, help_text="Treasurer State"
    )
    tres_zip4 = fields.CharField(
        max_length=10, db_column="TRES_ZIP4", blank=True, help_text="Treasurer ZIP+4"
    )
    xref_match = fields.CharField(
        max_length=1,
        db_column="XREF_MATCH",
...
original filing and 1 to 999 amendments.",
    ...
    intr_st = fields.CharField(
        max_length=2, db_column="INTR_ST", blank=True, help_text="Intermediary's state"
    )
    ...
    lndr_nams = fields.CharField(
        max_length=10, db_column="LNDR_NAMS", blank=True, help_text="Lender's suffix"
    )
...
value of this field.",
    ...
    loan_city = fields.CharField(
        max_length=30, db_column="LOAN_CITY", blank=True, help_text="Lender's city"
    )
...
CAL document for a description of the value of this field.",
    ...
    loan_st = fields.CharField(
        max_length=2, db_column="LOAN_ST", blank=True, help_text="Lender's state"
    )
    LOAN_TYPE_CHOICES = (
    ...
    loan_zip4 = fields.CharField(
        max_length=10, db_column="LOAN_ZIP4", blank=True, help_text="Lender's ZIP Code"
    )
    memo_code = fields.CharField(
        max_length=1, db_column="MEMO_CODE", blank=True, help_text="Memo amount flag"
    )
    memo_refno = fields.CharField(
        max_length=20,
        db_column="MEMO_REFNO",
...
the Form 401 Schedule A",
    ...
    ctrib_emp = fields.CharField(
        max_length=200, db_column="CTRIB_EMP", blank=True, help_text="Employer"
    )
    ...
    ctrib_occ = fields.CharField(
        max_length=60, db_column="CTRIB_OCC", blank=True, help_text="Occupation"
    )
    ...
    ctrib_st = fields.CharField(
        max_length=2, db_column="CTRIB_ST", blank=True, help_text="Contributor's State"
    )
...
list of legal values. Used on Form 401 Schedule A",
    ...
    rcpt_date = fields.DateField(
        db_column="RCPT_DATE", null=True, help_text="Date item received"
    )
    REC_TYPE_CHOICES = (
...
individual",
    ...
    payee_st = fields.CharField(
        max_length=2, db_column="PAYEE_ST", blank=True, help_text="Payee state address"
    )
    payee_zip4 = fields.CharField(
        max_length=10, db_column="PAYEE_ZIP4", blank=True, help_text="Payee ZIP Code"
    )
    amount = fields.DecimalField(
        max_digits=16,
        decimal_places=2,
...
as on the filing's cover (CVR) record.",
    ...
    electjuris = fields.CharField(
        db_column="ELECTJURIS", max_length=40, help_text="Jurisdiction of the election"
    )
...
class S496Cd(CalAccessBaseModel):
    ...
    FILING_FORMS = [annotations.get_form("F496")]
    filing_id = fields.IntegerField(
        db_column="FILING_ID",
        db_index=True,
        verbose_name="filing ID",
...
original filing and 1 to 999 amendments.",
    ...
    exp_date = fields.DateField(
        db_column="EXP_DATE", null=True, help_text="Expenditure dates"
    )
    expn_dscr = fields.CharField(
        max_length=90,
        db_column="EXPN_DSCR",
    ...
    date_thru = fields.DateField(
        db_column="DATE_THRU", null=True, help_text="End of date range for items paid"
    )
    ...
    def __str__(self):
        return "{} Filing {}, Amendment {}".format(
            self.form_type, self.filing_id, self.amend_id
        )
...
self-employed.',
    ...
    elec_date = fields.DateField(
        db_column="ELEC_DATE", null=True, help_text="Date of election"
    )
    ctrib_date = fields.DateField(
        db_column="CTRIB_DATE", null=True, help_text="Date item received/made"
    )
    date_thru = fields.DateField(
        db_column="DATE_THRU",
        null=True,
...
for Senate, Assembly, or Board of Equalization races.",
    ...
    bal_num = fields.CharField(
        max_length=7, db_column="BAL_NUM", blank=True, help_text="Ballot measure number"
    )
    bal_juris = fields.CharField(
        max_length=40,
        db_column="BAL_JURIS",
    ...
    def __str__(self):
        return "{} Filing {}, Amendment {}".format(
            self.get_form_type_display(), self.filing_id, self.amend_id
        )
...
original filing and 1 to 999 amendments.",
    ...
    payor_nams = fields.CharField(
        max_length=10, db_column="PAYOR_NAMS", blank=True, help_text="Payor's suffix."
    )
    payor_city = fields.CharField(
        max_length=30, db_column="PAYOR_CITY", blank=True, help_text="Payor's city."
    )
    payor_st = fields.CharField(
        max_length=2, db_column="PAYOR_ST", blank=True, help_text="Payor's State."
    )
    payor_zip4 = fields.CharField(
        max_length=10, db_column="PAYOR_ZIP4", blank=True, help_text="Payor's zip code"
    )
    date_rcvd = fields.DateField(
        db_column="DATE_RCVD", null=True, help_text="Date received"
    )
...
Populated for Senate, Assembly, or Board of Equalization races.",
    ...
    memo_code = fields.CharField(
        max_length=1, db_column="MEMO_CODE", blank=True, help_text="Memo amount flat"
    )
    memo_refno = fields.CharField(
        max_length=20,
        db_column="MEMO_REFNO",
...
original filing and 1 to 999 amendments.",
    ...
    ENTITY_CD_CHOICES = annotations.sort_choices(
        annotations.choices.CAMPAIGN_ENTITY_CODES
    ) + (("8", "Unknown"),)
    entity_cd = fields.CharField(
        db_column="ENTITY_CD",
        choices=ENTITY_CD_CHOICES,
    ...
    stmt_type = fields.IntegerField(
        ...
        choices=STMT_TYPE_CHOICES,
        help_text="Type of statement",
        documentcloud_pages=[DocumentCloud(id="2774529", start_page=6)],
    )
    ...
    agency_nam = fields.CharField(
        db_column="AGENCY_NAM", max_length=200, blank=True, help_text="Agency name"
    )
    JURIS_CD_CHOICES = (
        (0, "N/A"),
        (40501, "LOCAL"),
...
Populated for Senate, Assembly or Board of Equalization races.",
    ...
    party = fields.CharField(
        db_column="PARTY", max_length=200, blank=True, help_text="Political party"
    )
    yr_of_elec = fields.IntegerField(
        db_column="YR_OF_ELEC", blank=True, null=True, help_text="Year of election"
    )
    ELEC_TYPE_CHOICES = (
        (0, "N/A"),
        (3001, "GENERAL"),
    ...
    can_sig = fields.CharField(
        db_column="CAN_SIG", max_length=200, blank=True, help_text="Candidate signature"
    )
    account_no = fields.CharField(
        db_column="ACCOUNT_NO", max_length=32, blank=True, help_text="Account number"
    )
