...
class BallotMeasuresCd(CalAccessBaseModel):
    ...
    election_date = fields.DateField(
        db_column="ELECTION_DATE", null=True, help_text="Ballot measure election date"
    )
    ...
    measure_no = fields.CharField(
        db_column="MEASURE_NO", max_length=2, help_text="Ballot measure number"
    )
    measure_name = fields.CharField(
        db_column="MEASURE_NAME", max_length=163, help_text="Ballot measure full name"
    )
    ...
    jurisdiction = fields.CharField(
        db_column="JURISDICTION", max_length=9, help_text="This field is undocumented"
    )
...
class CvrF470Cd(CalAccessBaseModel):
    ...
    cand_st = fields.CharField(
        db_column="CAND_ST", blank=True, max_length=2, help_text="Filer's State"
    )
    cand_zip4 = fields.CharField(
        db_column="CAND_ZIP4", blank=True, max_length=10, help_text="Filer's zipcode"
    )
    ...
    ENTITY_CD_CHOICES = (("CAO", annotations.choices.CAMPAIGN_ENTITY_CODES["CAO"]),)
...
class LobbyistContributions1Cd(CalAccessBaseModel):
    ...
    amount = fields.FloatField(
        db_column="AMOUNT", blank=True, null=True, help_text="Amount received"
    )
...
class LobbyistEmpLobbyist1Cd(CalAccessBaseModel):
    ...
    lobbyist_last_name = fields.CharField(
        db_column="LOBBYIST_LAST_NAME", max_length=17, help_text="Lobbyist last name"
    )
    lobbyist_first_name = fields.CharField(
        db_column="LOBBYIST_FIRST_NAME", max_length=17, help_text="Lobbyist first name"
    )
    employer_name = fields.CharField(
        db_column="EMPLOYER_NAME", max_length=300, help_text="Employer name"
    )
...
class LobbyistEmployer1Cd(CalAccessBaseModel):
    ...
    current_qtr_amt = fields.FloatField(
        db_column="CURRENT_QTR_AMT", help_text="Current quarter amount"
    )
    session_total_amt = fields.FloatField(
        db_column="SESSION_TOTAL_AMT", help_text="Total amount for the session"
    )
...
class LobbyistEmployer2Cd(CalAccessBaseModel):
    ...
    interest_name = fields.CharField(
        db_column="INTEREST_NAME", max_length=24, blank=True, help_text="Interest name"
    )
    session_yr_1 = fields.IntegerField(
        db_column="SESSION_YR_1",
        verbose_name="Total amount of year 1 of the session",
...
class LobbyistEmployerHistoryCd(CalAccessBaseModel):
    ...
    contributor_id = fields.IntegerField(
        db_column="CONTRIBUTOR_ID", help_text="Contributor identification number."
    )
    current_qtr_amt = fields.IntegerField(
        db_column="CURRENT_QTR_AMT", help_text="Current Quarter Amount"
    )
    employer_id = fields.IntegerField(
        db_column="EMPLOYER_ID", help_text="Employer identification number."
    )
    employer_name = fields.CharField(
        db_column="EMPLOYER_NAME", max_length=300, blank=True, help_text="Employer Name"
    )
    INTEREST_CD_CHOICES = (
        (40301, "AGRICULTURE"),
        (40302, "EDUCATION"),
...
1 to 999 are amendments",
    ...
    per_total = fields.FloatField(
        db_column="PER_TOTAL", help_text="Total this reporting period"
    )
    cum_total = fields.FloatField(
        db_column="CUM_TOTAL", help_text="Cumulative total to date"
    )
...
class LobbyistFirmHistoryCd(CalAccessBaseModel):
    ...
    qtr_1 = fields.IntegerField(db_column="QTR_1", help_text="Quarter total amount.")
    qtr_2 = fields.IntegerField(db_column="QTR_2", help_text="Quarter total amount.")
    qtr_3 = fields.IntegerField(db_column="QTR_3", help_text="Quarter total amount.")
    qtr_4 = fields.IntegerField(db_column="QTR_4", help_text="Quarter total amount.")
    qtr_5 = fields.IntegerField(db_column="QTR_5", help_text="Quarter total amount.")
    qtr_6 = fields.IntegerField(db_column="QTR_6", help_text="Quarter total amount.")
    qtr_7 = fields.IntegerField(db_column="QTR_7", help_text="Quarter total amount.")
    qtr_8 = fields.IntegerField(db_column="QTR_8", help_text="Quarter total amount.")
    session_id = fields.IntegerField(
        db_column="SESSION_ID", help_text="Session identification number."
    )
    session_total_amt = fields.IntegerField(
        db_column="SESSION_TOTAL_AMT", help_text="Total amount for the session."
    )
    session_yr_1 = fields.IntegerField(
        db_column="SESSION_YR_1", help_text="Total amount for year 1 of the session."
    )
    session_yr_2 = fields.IntegerField(
        db_column="SESSION_YR_2", help_text="Total amount for year 2 of the session."
    )
    yr_1_ytd_amt = fields.IntegerField(
        db_column="YR_1_YTD_AMT",
        verbose_name="Year 1 year to date amount.",
...
class LobbyistFirmLobbyist1Cd(CalAccessBaseModel):
    ...
    lobbyist_last_name = fields.CharField(
        db_column="LOBBYIST_LAST_NAME", max_length=15, help_text="Lobbyist last name"
    )
    lobbyist_first_name = fields.CharField(
        db_column="LOBBYIST_FIRST_NAME", max_length=17, help_text="Lobbyist first name"
    )
...
class EfsFilingLogCd(CalAccessBaseModel):
    ...
    filing_date = fields.DateField(
        db_column="FILING_DATE", null=True, help_text="Date of filing"
    )
