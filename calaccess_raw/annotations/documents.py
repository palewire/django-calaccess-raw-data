...
class DocumentCloud(object):
    ...
    def __init__(self, id, start_page=None, end_page=None):
        ...
        self.metadata_cache_dir = os.path.join(
            settings.BASE_DIR, ".documentcloud_metadata"
        )
        self.metadata_filename = os.path.join(
            self.metadata_cache_dir, "{}.json".format(self.id)
        )
    ...
    def canonical_url(self):
        ...
        """
        if self.start_page:
            canonical_url = self.metadata["canonical_url"] + "#document/p{}".format(
                self.start_page
            )
        else:
    ...
    def pdf_url(self):
        ...
        """
        self._pdf_url = (
            f"https://assets.documentcloud.org/documents/{self.id}/{self.slug}.pdf"
        )
    ...
    def text_url(self):
        ...
        """
        self._text_url = (
            f"https://assets.documentcloud.org/documents/{self.id}/{self.slug}.txt"
        )
